...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], e) : e(t.$) }(this, function(t) {
    "use strict";
    ...
    function i(t, a) { var i = []; return e(a) && i.push(a), i.slice.apply(t, i) }

    function o(t, e) { for (var a = arguments.length, o = Array(a > 2 ? a - 2 : 0), n = 2; n < a; n++) o[n - 2] = arguments[n]; return function() { for (var a = arguments.length, n = Array(a), r = 0; r < a; r++) n[r] = arguments[r]; return t.apply(e, o.concat(i(n))) } }

    function n(e) { var a = []; return t.each(e, function(t) { a.push(t) }), a }

    function r(t) { var e = t.match(/^(https?:)\/\/([^:\/?#]+):?(\d*)/i); return e && (e[1] !== location.protocol || e[2] !== location.hostname || e[3] !== location.port) }

    function h(t) { var e = "timestamp=" + (new Date).getTime(); return t + (t.indexOf("?") === -1 ? "?" : "&") + e }

    function s(t) { return t ? ' crossOrigin="' + t + '"' : "" }
    ...
    function l(a, i) {
        var o = t("<canvas>")[0],
            ...
            b = void 0,
            y = void 0;
        return g && (w = v / 2, b = x / 2), m && (y = p({ width: v, height: x, degree: c }), v = y.width, x = y.height, w = v / 2, b = x / 2), o.width = v, o.height = x, u && (r = -s / 2, h = -d / 2, n.save(), n.translate(w, b)), m && n.rotate(c * Math.PI / 180), g && n.scale(l, f), n.drawImage(a, Math.floor(r), Math.floor(h), Math.floor(s), Math.floor(d)), u && n.restore(), o
    }
    ...
    function g(t) {
        ...
        if (255 === e.getUint8(0) && 216 === e.getUint8(1))
            for (p = 2; p < a;) {
                if (255 === e.getUint8(p) && 225 === e.getUint8(p + 1)) { d = p; break }
                p++
            }
        if (d && (o = d + 4, n = d + 10, "Exif" === f(e, o, 4) && (s = e.getUint16(n), h = 18761 === s, (h || 19789 === s) && 42 === e.getUint16(n + 2, h) && (r = e.getUint32(n + 4, h), r >= 8 && (c = n + r)))), c)
            for (a = e.getUint16(c, h), l = 0; l < a; l++)
                if (p = c + 12 * l + 2, 274 === e.getUint16(p, h)) { p += 8, i = e.getUint16(p, h), B && e.setUint16(p, 1, h); break }
        return i
    }
    ...
    function x(e) {
        ...
        }), i.sort(function(t, e) { return Math.abs(t) < Math.abs(e) }), i[0]
    }
    ...
    var b = { viewMode: 0, dragMode: "crop", aspectRatio: NaN, data: null, preview: "", responsive: !0, restore: !0, checkCrossOrigin: !0, checkOrientation: !0, modal: !0, guides: !0, center: !0, highlight: !0, background: !0, autoCrop: !0, autoCropArea: .8, movable: !0, rotatable: !0, scalable: !0, zoomable: !0, zoomOnTouch: !0, zoomOnWheel: !0, wheelZoomRatio: .1, cropBoxMovable: !0, cropBoxResizable: !0, toggleDragModeOnDblclick: !0, minCanvasWidth: 0, minCanvasHeight: 0, minCropBoxWidth: 0, minCropBoxHeight: 0, minContainerWidth: 200, minContainerHeight: 100, ready: null, cropstart: null, cropmove: null, cropend: null, crop: null, zoom: null },
        ...
        D = {
            ...
            initContainer: function() {
                var t = this,
                    ...
                    o = t.$cropper,
                    n = "cropper-hidden";
                o.addClass(n), a.removeClass(n), o.css(t.container = { width: Math.max(i.width(), Number(e.minContainerWidth) || 200), height: Math.max(i.height(), Number(e.minContainerHeight) || 100) }), a.addClass(n), o.removeClass(n)
            },
            initCanvas: function() {
                var e = this,
                ...
                var m = { naturalWidth: c, naturalHeight: p, aspectRatio: l, width: f, height: g };
            ...
            renderCanvas: function(t) {
                ...
                }(a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft), (a.height > a.maxHeight || a.height < a.minHeight) && (a.top = a.oldTop), a.width = Math.min(Math.max(a.width, a.minWidth), a.maxWidth), a.height = Math.min(Math.max(a.height, a.minHeight), a.maxHeight), e.limitCanvas(!1, !0), a.oldLeft = a.left = Math.min(Math.max(a.left, a.minLeft), a.maxLeft), a.oldTop = a.top = Math.min(Math.max(a.top, a.minTop), a.maxTop), e.$canvas.css({ width: a.width, height: a.height, transform: c({ translateX: a.left, translateY: a.top }) }), e.renderImage(), e.cropped && e.limited && e.limitCropBox(!0, !0), t && e.output()
            },
            renderImage: function(e) {
                var a = this,
                    ...
                    o = a.image,
                    n = void 0;
                o.rotate && (n = p({ width: i.width, height: i.height, degree: o.rotate, aspectRatio: o.aspectRatio }, !0)), t.extend(o, n ? { width: n.width, height: n.height, left: (i.width - n.width) / 2, top: (i.height - n.height) / 2 } : { width: i.width, height: i.height, left: 0, top: 0 }), a.$clone.css({ width: o.width, height: o.height, transform: c(t.extend({ translateX: o.left, translateY: o.top }, o)) }), e && a.output()
            },
        ...
        X = {
            initPreview: function() {
                ...
                e.$preview = t(e.options.preview), e.$clone2 = o = t("<img " + a + ' src="' + i + '">'), e.$viewBox.html(o), e.$preview.each(function(e, o) {
                    var n = t(o);
                    n.data(T, { width: n.width(), height: n.height(), html: n.html() }), n.html("<img " + a + ' src="' + i + '" style="display:block;width:100%;height:auto;min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;image-orientation:0deg!important;">')
                })
            },
            ...
            preview: function() {
                ...
                e.cropped && !e.disabled && (e.$clone2.css({ width: h, height: s, transform: c(t.extend({ translateX: -d, translateY: -p }, a)) }), e.$preview.each(function(e, i) {
                    var o = t(i),
                        ...
                        u = g,
                        v = 1;
                    n && (v = f / n, u = r * v), r && u > g && (v = g / r, m = n * v, u = g), o.css({ width: m, height: u }).find("img").css({ width: h * v, height: s * v, transform: c(t.extend({ translateX: -d * v, translateY: -p * v }, a)) })
                }))
            }
        },
        ...
        F = {
            resize: function() {
                ...
                if (!e.disabled && o) {
                    ...
                    1 === n && i.height() === o.height || ! function() {
                        var i = void 0,
                            o = void 0;
                        a && (i = e.getCanvasData(), o = e.getCropBoxData()), e.render(), a && (e.setCanvasData(t.each(i, function(t, e) { i[t] = e * n })), e.setCropBoxData(t.each(o, function(t, e) { o[t] = e * n })))
                    }()
                }
            },
            dblclick: function() {
            ...
            wheel: function(t) {
                ...
                if (!e.disabled && (t.preventDefault(), !e.wheeling)) {
                    e.wheeling = !0, setTimeout(function() { e.wheeling = !1 }, 50);
                    var o = 1;
            ...
            cropStart: function(e) {
                ...
                if (!a.disabled) {
                    var i = a.options,
                        ...
                        r = e.originalEvent,
                        h = void 0;
                    if (r && r.changedTouches ? t.each(r.changedTouches, function(t, e) { o[e.identifier] = v(e) }) : o[r && r.pointerId || 0] = v(e), h = n(o).length > 1 && i.zoomable && i.zoomOnTouch ? "zoom" : t(e.target).data("action"), j.test(h)) {
            ...
            cropMove: function(e) {
                ...
                if (!a.disabled && i) {
                    var o = a.pointers,
                        n = e.originalEvent;
                    e.preventDefault(), a.trigger("cropmove", { originalEvent: n, action: i }).isDefaultPrevented() || (n && n.changedTouches ? t.each(n.changedTouches, function(e, a) { t.extend(o[a.identifier], v(a, !0)) }) : t.extend(o[n && n.pointerId || 0], v(e, !0)), a.change(e))
                }
            },
            cropEnd: function(e) {
                var a = this,
                ...
                if (!a.disabled && i) {
                    var o = a.pointers,
                        r = e.originalEvent;
                    e.preventDefault(), r && r.changedTouches ? t.each(r.changedTouches, function(t, e) { delete o[e.identifier] }) : delete o[r && r.pointerId || 0], n(o).length || (a.action = ""), a.cropping && (a.cropping = !1, a.$dragBox.toggleClass("cropper-modal", a.cropped && a.options.modal)), a.trigger("cropend", { originalEvent: r, action: i })
                }
            }
        },
        q = "e",
            ...
            change: function(e) {
                ...
                switch (p && (B.X = B.y * p, B.Y = B.x / p), c) {
                    case "all":
                        ...
                        break;
                    case q:
                        if (B.x >= 0 && (u >= y || p && (m <= b || v >= C))) { M = !1; break }
                        l += B.x, p && (f = l / p, m -= B.Y / 2), l < 0 && (c = S, l = 0);
                        break;
                    case Z:
                        if (B.y <= 0 && (m <= b || p && (g <= w || u >= y))) { M = !1; break }
                        f -= B.y, m += B.y, p && (l = f * p, g += B.X / 2), f < 0 && (c = K, f = 0);
                        break;
                    case S:
                        if (B.x <= 0 && (g <= w || p && (m <= b || v >= C))) { M = !1; break }
                        l -= B.x, g += B.x, p && (f = l / p, m += B.Y / 2), l < 0 && (c = q, l = 0);
                        break;
                    case K:
                        if (B.y >= 0 && (v >= C || p && (g <= w || u >= y))) { M = !1; break }
                        f += B.y, p && (l = f * p, g -= B.X / 2), f < 0 && (c = Z, f = 0);
                        break;
                    case J:
                        if (p) {
                            if (B.y <= 0 && (m <= b || u >= y)) { M = !1; break }
                            f -= B.y, m += B.y, l = f * p
                ...
                M && (d.width = l, d.height = f, d.left = g, d.top = m, a.action = c, a.renderCropBox()), t.each(o, function(t, e) { e.startX = e.endX, e.startY = e.endY })
            }
        },
        ...
        at = function(t) { if (Array.isArray(t)) { for (var e = 0, a = Array(t.length); e < t.length; e++) a[e] = t[e]; return a } return Array.from(t) },
        it = {
            crop: function() {
                var t = this;
            ...
            clear: function() {
                var e = this;
                e.cropped && !e.disabled && (t.extend(e.cropBox, { left: 0, top: 0, width: 0, height: 0 }), e.cropped = !1, e.renderCropBox(), e.limitCanvas(!0, !0), e.renderCanvas(), e.$dragBox.removeClass("cropper-modal"), e.$cropBox.addClass("cropper-hidden"))
            },
            replace: function(t, e) { var a = this;!a.disabled && t && (a.isImg && a.$element.attr("src", t), e ? (a.url = t, a.$clone.attr("src", t), a.ready && a.$preview.find("img").add(a.$clone2).attr("src", t)) : (a.isImg && (a.replaced = !0), a.options.data = null, a.load(t))) },
            enable: function() {
                var t = this;
            ...
            zoomTo: function(t, e) {
                ...
                if (t = Number(t), t >= 0 && a.ready && !a.disabled && i.zoomable) {
                    var p = d * t,
                        l = c * t,
                        f = void 0;
                    if (e && (f = e.originalEvent), a.trigger("zoom", { originalEvent: f, oldRatio: h / d, ratio: p / d }).isDefaultPrevented()) return;
                    if (f) {
                        var g = a.$cropper.offset(),
                            m = o && n(o).length ? w(o) : { pageX: e.pageX || f.pageX || 0, pageY: e.pageY || f.pageY || 0 };
            ...
            getData: function(e) {
                var a = this,
                    ...
                    h = void 0,
                    s = void 0;
                return a.ready && a.cropped ? (s = { x: r.left - n.left, y: r.top - n.top, width: r.width, height: r.height }, h = o.width / o.naturalWidth, t.each(s, function(t, a) { a /= h, s[t] = e ? Math.round(a) : a })) : s = { x: 0, y: 0, width: 0, height: 0 }, i.rotatable && (s.rotate = o.rotate || 0), i.scalable && (s.scaleX = o.scaleX || 1, s.scaleY = o.scaleY || 1), s
            },
            setData: function(a) {
                var i = this,
                    o = i.options,
            ...
            getContainerData: function() { return this.ready ? this.container : {} },
            getImageData: function() { return this.loaded ? this.image : {} },
            getCanvasData: function() {
                var e = this,
                    a = e.canvas,
                    i = {};
                return e.ready && t.each(["left", "top", "width", "height", "naturalWidth", "naturalHeight"], function(t, e) { i[e] = a[e] }), i
            },
        ...
        ht = function() {
            ...
            return et(e, [{
            ...
            }, { key: "trigger", value: function(e, a) { var i = t.Event(e, a); return this.$element.trigger(i), i } }, {
                key: "load",
                value: function(e) {
                    var a = this,
                        i = a.options,
                    ...
                    if (e) {
                        ...
                        n.onerror = n.onabort = t.proxy(function() { a.clone() }, this), n.onload = function() { a.read(this.response) }, i.checkCrossOrigin && r(e) && o.prop("crossOrigin") && (e = h(e)), n.open("get", e), n.responseType = "arraybuffer", n.withCredentials = "use-credentials" === o.prop("crossOrigin"), n.send()
                    }
                }
            }, {
                key: "read",
                ...
                value: function() {
                    var e = this,
                        a = e.$clone,
                        i = e.$element;
                    e.isImg || (a.off("error", e.stop), i = a), d(i[0], function(a, i) { t.extend(e.image, { naturalWidth: a, naturalHeight: i, aspectRatio: a / i }), e.loaded = !0, e.build() })
                }
            }, {
                key: "stop",
                value: function() {
            ...
            }], [{ key: "setDefaults", value: function(e) { t.extend(b, t.isPlainObject(e) && e) } }]), e
        }();
    ...
    }, t.fn.cropper.Constructor = ht, t.fn.cropper.setDefaults = ht.setDefaults, t.fn.cropper.noConflict = function() { return t.fn.cropper = dt, this }
});